...
public class Property_list_3 extends AppCompatActivity {
    ...
    private void fetch1BHKProperties() {
        DatabaseReference dbRef = FirebaseDatabase.getInstance().getReference("Properties").child("PG");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    Toast.makeText(Property_list_3.this, "No properties found.", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Property_list_3.this, "Failed to load data", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void addPropertyToUI(String name, String location, String area, String price, String squareFeet, String type) {
        ...
        imgProperty.setImageResource(R.drawable.pg); // Set a default image from drawable
        ...
        propertyView.setOnClickListener(v -> {
            Intent intent = new Intent(Property_list_3.this, PropertyDetails.class);
