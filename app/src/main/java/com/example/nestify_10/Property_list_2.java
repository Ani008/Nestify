...
public class Property_list_2 extends AppCompatActivity {
    ...
    private void fetch1BHKProperties() {
        DatabaseReference dbRef = FirebaseDatabase.getInstance().getReference("Properties").child("2 BHK");
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    Toast.makeText(Property_list_2.this, "No properties found.", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Property_list_2.this, "Failed to load data", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void addPropertyToUI(String name, String location, String area, String price, String squareFeet, String type) {
        ...
        imgProperty.setImageResource(R.drawable.bhk_2); // Set a default image from drawable
        ...
        propertyView.setOnClickListener(v -> {
            Intent intent = new Intent(Property_list_2.this, PropertyDetails_2BHK.class);
